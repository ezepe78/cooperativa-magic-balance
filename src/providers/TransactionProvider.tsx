...
import { fetchTransactions, addTransaction as apiAddTransaction, updateTransaction, deleteTransaction as apiDeleteTransaction } from '@/services/transactionService';
...
import { calculateBalance, calculateTotalBalance, getMonthlySummary as calculateMonthlySummary } from '@/utils/financialCalculators';
...
export const TransactionProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const getBalanceHandler = (account: TreasuryAccount) => {
    return calculateBalance(transactions, account, initialBalances[account]);
  };

  const getTotalBalanceHandler = () => {
