...
export const calculateTotalBalance = (
  ...
  const cashBalance = calculateBalance(transactions, 'cash', initialBalances.cash);
  const bancoProvinciaBalance = calculateBalance(transactions, 'banco_provincia', initialBalances.banco_provincia);
  
  return cashBalance + bancoProvinciaBalance;
};
